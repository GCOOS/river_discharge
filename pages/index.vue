<template>
  <div class="canvas">
    ...
    <script
      async
      defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAT-25-xVEY8DczyQ3Uvk81e0DpXO6fCOY&callback=initMap&region=GB"
      type="text/javascript"
    ></script>
    <script type="text/javascript" src="js/google_riverdischarge.js"></script>
  </div>
</template>
